...
# TODO: update main.nf related to this argument
pa.add_argument(
...
of_ibddist_ibdobj = f"{label_str}.ibddist.ibdobj.gz"
...
if len(args.ibd_files_true) != 0:
    ...
    # load filterred IBD
    ibd_filt = ibdutils.IBD(genome=genome_Pf3D7_numeric, label=f"{label_str}_orig")
