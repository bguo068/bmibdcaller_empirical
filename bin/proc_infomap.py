...
# Note this option is not used for infomap, only used for preparing input of
# IBDNe in proc_dist_ne.py
pa.add_argument(
...
ibd.read_ibd(ibd_fn_lst=args.ibd_files, rm_sample_name_suffix=False)


# output files:
of_ifm_orig_ibdobj = f"{label}_orig.ifm.ibdobj.gz"
of_ifm_rmpeaks_ibdobj = f"{label}_rmpeaks.ifm.ibdobj.gz"
